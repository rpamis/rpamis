 ...
 * 包装自定义异常，用于业务上减少if判断后手动从ExceptionFactory抛异常的情况 适配class动态推断
 *
 * @author benym
...
public abstract class Assert {
	...
	public static <T extends AbstractException> void doesNotContain(String textToSearch, String substring,
