...
public class DubboExceptionFilter implements Filter {
  ...
  public Result invoke(Invoker<?> invoker, Invocation invocation) throws RpcException {
    ...
    logger.info(
        "Global dubbo exception filter, requestId:{}, spanId:{}, interface:{}, methodName:{}, params:{}",
        trace.getTraceId(), trace.getSpanId(), invoker.getInterface(), invocation.getMethodName(),
        params);
