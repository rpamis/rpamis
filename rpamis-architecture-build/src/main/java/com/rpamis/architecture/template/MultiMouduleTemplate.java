...
public class MultiMouduleTemplate extends AbstractBuildTemplate {
	...
	protected void initPath() {
		...
		// 构建出各模块的基础base路径
		String apiBasePath = cachePath + apiMoudule + File.separator;
		String daoBasePath = cachePath + daoMoudule + File.separator;
		String serviceBasePath = cachePath + serviceMoudule + File.separator;
		String webBasePath = cachePath + webMoudule + File.separator;
		// 构建出各模块的基础src路径
