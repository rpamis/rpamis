...
public class RequestLog {
	...
	public String toString() {
		return "RequestLog{" + "requestUrl='" + requestUrl + '\'' + ", remoteAddr='" + remoteAddr + '\''
				+ ", requestHeaders=" + requestHeaders + ", method='" + method + '\'' + ", requestParams="
				+ requestParams + ", status=" + status + ", responseHeaders=" + responseHeaders + ", response="
